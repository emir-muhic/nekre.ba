...
<head>
    ...
    <title>FAQ - Agencija za nekretnine Tuzla</title>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="ltn__breadcrumb-inner">
                        <h1 class="page-title">Često postavljena pitanja</h1>
                        <div class="ltn__breadcrumb-list">
                            <ul>
                                <li><a href="index.html"><span class="ltn__secondary-color"><i class="fas fa-home"></i></span> Početna</a></li>
                                <li>FAQ</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="ltn__faq-inner ltn__faq-inner-2">
                        <div id="accordion_2">
                            ...
                            <div class="card">
                                ...
                                Šta je kapara i koliko iznosi?
                                </h6>
                                <div id="faq-item-2-1" class="collapse" data-bs-parent="#accordion_2">
                                    <div class="card-body">
                                        <p>Kapara je polog koji kupac nekretnine isplaćuje kupcu iskazujući namjeru kupovine nekretnine. Određuje se prema dogovoru, a najčešće iznosi 10% od ukupno ugovorene kupoprodajne cijene. Kapara predstavlja znak ozbiljnosti poslovanja i stvarne namjere kupovine nekretnina. Kapara je upotpunosti regulisana Zakonom o obligacionim odnosima.</p>
                                    </div>
                                </div>
                            </div>
                            <!-- card -->
                            <div class="card">
                                ...
                                Kako izbjeći moguće probleme pri kupovini nekretnine?
                                </h6>
                            ...
                            <div class="card">
                                ...
                                <div id="faq-item-2-3" class="collapse" data-bs-parent="#accordion_2">
                                    <div class="card-body">
                                        <p>Izjava kojom kupac i prodavac izjavljuju da je kupac primio cjelokupni iznos ugovorene kupoprodajne cijene, stoga kupcu dozvoljava zemljišno-knjižni prijenos prava vlasništva na nekretninu koja je predmet kupoprodajnog ugovora na svoje ime.</p>
                                    </div>
                                </div>
                            </div>
                            <!-- card -->
                            <div class="card">
                                ...
                                Plaća li se PDV pri kupovini nekretnine?
                                </h6>
                                <div id="faq-item-2-4" class="collapse" data-bs-parent="#accordion_2">
                                    <div class="card-body">
                                        <p>Prema Zakonu o PDV-u pri kupnji novosagrađenih stanova u novoizgrađenim zgradama plaća se PDV u visini od 17%.</p>
                                    </div>
                                </div>
                            </div>
                            <!-- card -->
                            <div class="card">
                                ...
                                Kako se oporezuje najam nekretnine?
                                </h6>
                                <div id="faq-item-2-5" class="collapse" data-bs-parent="#accordion_2">
                                    <div class="card-body">
                                        <p>Kada fizička osoba daje u najam nekretninu (stan, kuću ili poslovni prostor) porez na prihod od imovine plaća zakupodavac.</p>
                                    </div>
                                </div>
                            </div>
                            <!-- card -->
                            <div class="card">
                                ...
                                Ko određuje cijenu nekretnine?
                                </h6>
                                <div id="faq-item-2-6" class="collapse" data-bs-parent="#accordion_2">
                                    <div class="card-body">
                                        <p>Cijenu nekretnine određuje njen prodavac u skladu sa ponudom i potražnjom.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="need-support text-center mt-100">
                            <h2>Trebate pomoć? Kontaktirjte nas 24/7:</h2>
                            <div class="btn-wrapper mb-30">
                                <a href="../kontakt" class="theme-btn-1 btn">Kontaktirajte nas</a>
                            </div>
                            <h3><i class="fas fa-phone"></i> +387 61 663 666</h3>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <aside class="sidebar-area ltn__right-sidebar">
                        ...
                        <div class="widget ltn__search-widget ltn__newsletter-widget">                            
                            <h6 class="ltn__widget-sub-title">// pretplati se</h6>
                            <h4 class="ltn__widget-title">Email obavijesti</h4>
                            <form action="#">
                                <input type="text" name="search" placeholder="Email adresa">
