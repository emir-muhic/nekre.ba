...
<head>
    ...
    <title>O nama - Agencija za nekretnine Tuzla</title>
                ...
                <div class="col-lg-6 align-self-center">
                    <div class="about-us-info-wrap">
                        <div class="section-title-area ltn__section-title-2--- mb-20">
                            <h6 class="section-subtitle section-subtitle-2 ltn__secondary-color">O nama</h6>
                            <h1 class="section-title">Agencija za nekretnine<span>.</span></h1>
                            <p>Agencija za nekretnine NEKRE je specijalizovano preduzeće za promet nekretninama, stručno i tehnički osposobljeno za pružanje usluga, posredovanja pri kupovini ili prodaji nekretnina, iznamljivanju ili izdavanju, kao i u procjenama vrijednosti nekretnina.</p>
                            <p>Vjerujemo kako je osobni pristup svakom klijentu i svakoj nekretnini, te detaljno razumijevanje potreba naših klijenata ključ uspješnog pronalaska savršene nekretnine. Iz tog razloga naš pristup i filozofiju poslovanja temeljimo na Vama. Razumijemo što je sve potrebno kako bi proces pronalaska idealnog prostora bio ugodan proces za svakoga našeg klijenta i svaku njegovu potrebu.</p>
                            <p>Pouzdanost, kompetentnost i nadasve diskrecija su za nas najvažniji stup našeg poslovanja, što nas čini uspješnim u našem poslu.</p>
                            <p>Zajedno rastemo s jedinom misijom - biti najbolji u onome što radimo, kako bismo najbolje mogli služiti u svim vašim potrebama vezanima uz nekretnine. Nadamo se da ćete nam pokloniti svoje povjerenje i omogućiti da vam pokažemo našu svrhu u praksi.</p>
                            <p>Radujemo se suradnji s Vama!</p>
                            <p>Vaš NEKRE tim</p>
                        </div>
                    </div>
                </div>
    ...
    <div class="ltn__team-area pt-115 pb-90">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title-area ltn__section-title-2--- text-center">
                        <h6 class="section-subtitle section-subtitle-2 ltn__secondary-color">Nekre tim</h6>
                        <h1 class="section-title">Agent za nekretnine</h1>
                    </div>
                </div>
            </div>
            <div class="row justify-content-center">
                <div class="col-lg-4 col-sm-6">
                    <div class="ltn__team-item ltn__team-item-3---">
                        ...
                        <div class="team-info">
                            <h4><a href="#">Slađan Suljetović dipl.iur.</a></h4>
                            <h6 class="ltn__secondary-color">Agent za nekretnine</h6>
                            <div class="ltn__social-media">
                                <ul>
                                    <li><a href="https://www.facebook.com/nekre.ba/"><i class="fab fa-facebook-f"></i></a></li>
                                    <li><a href="https://www.youtube.com/channel/UCoP8Inu_mE0F4oQCq1rOkIw"><i class="fab fa-youtube"></i></a></li>
                                    <li><a href="https://www.instagram.com/agencija_nekre/"><i class="fab fa-instagram"></i></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
