...
<head>
    ...
    <title>Kontakt - Agencija za nekretnine Tuzla</title>
...
<div class="body-wrapper">
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="ltn__contact-address-item ltn__contact-address-item-3 box-shadow">
                        ...
                        <h3>Adresa poslovnice</h3>
                        <p>Slatina br. 6, Tuzla</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="ltn__form-box contact-form-box box-shadow white-bg">
                        <h4 class="title-2">Kontakt formular</h4>
                        <form id="contact-form" action="mail.php" method="post">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="input-item input-item-email ltn__custom-icon">
                                        <input type="email" name="email" placeholder="Unesite email adresu">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="input-item">
                                        <select class="nice-select">
                                            <option>Izaberite tip usluge</option>
                            ...
                            <p><label class="input-info-save mb-0"><input type="checkbox" name="agree"> Sačuvaj moje ime, email i web stranicu u pretraživaču za naredni puta. </label></p>
                            <div class="btn-wrapper mt-0">
                                <button class="btn theme-btn-1 btn-effect-1 text-uppercase" type="submit">Pošalji upit</button>
                            </div>
    ...
    <div class="google-map mb-120">
        ...
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2843.7386325061193!2d18.661093928713345!3d44.54098391225483!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x475ead1b74df36cb%3A0xd4fe223c2591ab31!2sSlatina%206%2C%20Tuzla%2075000!5e0!3m2!1shr!2sba!4v1660566046569!5m2!1shr!2sba" width="100%" height="100%" frameborder="0" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
